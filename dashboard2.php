...
<!-- start a wrapper -->
	...
	<div class="blogpost-box col-sm-12 col-xs-12">
        ...
        <h1 class="dashboard-title"><?php if ( isset($_SESSION['msg']) ) { echo $_SESSION['msg']; unset($_SESSION['msg']); } else echo "Dags att skriva nästa succéinlägg?" ?></h1>
			<form method="POST" action="dashboard.php" class="blogposts" enctype="multipart/form-data">
                ...
                // försöker fixa så att koden inte hårdkodas!! 
        ...
        */
        ...
        if (isset($_POST["draft"])) {
            if (!empty($_POST["blogpost_title"]) &&
                ...
                $query = "
                INSERT INTO posts 
                VALUES (NULL, '{$timeStamp}', '', '{$title}', '{$text}', FALSE, '$user_id', '$category')
                ";
